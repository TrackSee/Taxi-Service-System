...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="<%=application.getContextPath()%>/resources/admin/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<%=application.getContextPath()%>/resources/admin/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<%=application.getContextPath()%>/resources/admin/bower_components/morrisjs/morris.css" rel="stylesheet">
...
<script src="<%=application.getContextPath()%>/resources/admin/bower_components/raphael/raphael-min.js"></script>
<script src="<%=application.getContextPath()%>/resources/admin/bower_components/morrisjs/morris.min.js"></script>
<script src="<%=application.getContextPath()%>/resources/admin/js/morris-data.js"></script>
