...
<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
  ...
  <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        ...
        <%--Change Tariff--%>
        <li><a href="<%=application.getContextPath()%>/admin/tariff"><i class="fa fa-dollar fa-fw"></i> Tariffs</a></li>
        <%--block users account--%>
        <li><a href="<%=application.getContextPath()%>/admin/block"><i class="fa fa-lock fa-fw"></i> Block User</a></li>
        <%--groups edit--%>
        <li><a href="<%=application.getContextPath()%>/admin/groups"><i class="fa fa-group fa-fw"></i> Groups and roles</a></li>
