...
<%@ page contentType="text/html;charset=UTF-8" language="java" pageEncoding="UTF-8"%>
    <!-- start: CSS -->
    <link href="<%=application.getContextPath()%>/resources/bootstrap/css/bootstrap.css" rel="stylesheet">
    ...
    <link href="<%=application.getContextPath()%>/resources/customer/css/textOutline.css" rel="stylesheet">
